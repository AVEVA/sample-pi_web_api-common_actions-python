...
from appsettings import PIWEBAPI_URL, AF_SERVER_NAME, PI_SERVER_NAME, USER_NAME, USER_PASSWORD, AUTH_TYPE, VERIFY_SSL
...
class TestStringMethods(unittest.TestCase):
    ...
    def test_createdatabase(self):
        ...
        self.assertEqual(create_database(PIWEBAPI_URL,
                                         AF_SERVER_NAME, USER_NAME, USER_PASSWORD, AUTH_TYPE, VERIFY_SSL), 201)
    ...
    def test_createtemplate(self):
        ...
        self.assertEqual(create_template(PIWEBAPI_URL,
                                         AF_SERVER_NAME, PI_SERVER_NAME, USER_NAME, USER_PASSWORD, AUTH_TYPE, VERIFY_SSL), 201)
